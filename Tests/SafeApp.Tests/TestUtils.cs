...
namespace SafeApp.Tests
{
    public static class TestUtils
    {
        ...
        public static Task<NewSession> CreateTestApp()
        {
        ...
        public static Task<NewSession> CreateTestApp(AuthReq authReq)
        {
            var locator = GetRandomString(10);
            var secret = GetRandomString(10);
            return CreateTestApp(locator, secret, authReq);
        ...
        public static async Task<NewSession> CreateTestApp(string locator, string secret, AuthReq authReq)
        {
