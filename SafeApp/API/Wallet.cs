...
namespace SafeApp.API
{
    ...
    public class Wallet
    {
        ...
        public Task<string> WalletCreateAsync()
            => AppBindings.WalletCreateAsync(ref _appPtr);
        ...
        public Task<string> WalletInsertAsync(
            ...
            bool setDefault,
            string secretKey)
            => AppBindings.WalletInsertAsync(ref _appPtr, keyUrl, name, setDefault, secretKey);
        ...
        public Task<string> WalletBalanceAsync(string url)
            => AppBindings.WalletBalanceAsync(ref _appPtr, url);
        ...
        public Task<(WalletSpendableBalance, ulong)> WalletGetDefaultBalanceAsync(string url)
            => AppBindings.WalletGetDefaultBalanceAsync(ref _appPtr, url);
        ...
        public Task<ulong> WalletTransferAsync(
            ...
            string amount,
            ulong id)
            => AppBindings.WalletTransferAsync(ref _appPtr, from, to, amount, id);
        ...
        public Task<WalletSpendableBalances> WalletGetAsync(string url)
            => AppBindings.WalletGetAsync(ref _appPtr, url);
    }
}
